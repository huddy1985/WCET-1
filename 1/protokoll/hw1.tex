...
%TODO fragen ob das eh gemeint ist
}
...
{
\lstinputlisting[linerange=127-145,basicstyle=\footnotesize]{../monitor_task/task.c}
}
...
%TODO warum nicht 192 als flow constraint
\begin{tabular}{|c|c|}
    \hline
 type & cycles \\ \hline
